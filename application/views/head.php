...
<html lang="en">
  ...
  <body class="nav-md">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Master Data <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('index.php/k_obat') ?>">Obat</a></li>
    ...
    <!-- Bootstrap -->
  <?php echo base_url('assets') ?><script src="<?php echo base_url('assets') ?>/vendors/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- FastClick -->
